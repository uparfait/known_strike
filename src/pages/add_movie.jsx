...
const AddMovie = () => {
  ...
  const fetch_all_countries = async () => {
    try {
      const countries = await api_request("GET", "/countries");
      if (countries.data.success) {
        set_countries(countries.data.countries);
      } else {
        throw countries.data.error;
      }
    } catch (e) {
      toast.error("Failed to fetch countries: " + e.message);
    }
  };
    ...
    const fetch_suggestions = async () => {
      ...
      try {
        const response = await api_request(
          "GET",
          `/search?q=${encodeURIComponent(linked_search_query)}&limit=5`
        );
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <form
        ...
        className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 space-y-8"
      >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                value={form_data.players}
                onChange={(e) => handle_input_change("players", e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                placeholder="Players separated by commers Ex: aaa,bbb,ccc"
                required
              />
            </div>
            ...
            <div className="flex gap-2">
              <select
                ...
                onChange={(e) => handle_input_change("country", e.target.value)}
                className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                required
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handle_input_change("thumbnail_image", e.target.value)
                }
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handle_input_change("download_url", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Movie Description (100-500 characters){" "}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handle_input_change("release_date", e.target.value)
                }
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handle_input_change("display_language", e.target.value)
                }
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handle_input_change("views", parseInt(e.target.value) || 0)
                }
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                min="0"
                placeholder="0"
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:border-indigo-500 transition-colors">
                <input
                  ...
                  onChange={(e) =>
                    handle_input_change("is_interpreted", e.target.checked)
                  }
              ...
              {form_data.is_interpreted && (
                <div className="pl-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handle_input_change("interpreter", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer p-3 rounded-lg border border-gray-300 dark:border-gray-600 hover:border-indigo-500 transition-colors">
                <input
                  ...
                  onChange={(e) =>
                    handle_input_change("is_serie", e.target.checked)
                  }
                  className="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          handle_input_change("linked_serie", e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          set_show_linked_search(!show_linked_search)
                        }
                    ...
                    {show_linked_search && (
                      <div className="mt-2 bg-white dark:bg-gray-700 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 overflow-hidden">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            set_linked_search_query(e.target.value)
                          }
                          ...
                          <div className="py-1 max-h-60 overflow-y-auto">
                            {suggestions.map((suggestion, index) => (
                              <button
                                ...
                                onClick={() =>
                                  handle_linked_movie_select(suggestion)
                                }
                              >
                                <img
                                  src={
